...
if __name__ == '__main__':
    ...
    # 生成图分割的鱼眼图
    split_path = './data/3.streetview_split'      # 裁剪后的街景（图分割）
    fisheye_path = './data/5.streetview_fisheye_split'  # 创建鱼眼图后，导出到那个文件夹

    angle_path = './data/0.beijing_y15-22m5-10_9.9w.csv'     # 鱼眼图旋转角度储存的文件位置
    # 获取所有的旋转角度储存的字典
